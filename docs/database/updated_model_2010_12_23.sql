...
CREATE  TABLE IF NOT EXISTS `capston4_wins`.`share` (
  ...
  `shared_wins` VARCHAR(9) CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci' NULL ,
  `shared_wants` VARCHAR(9) CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci' NULL ,
  `shared_user_id` INT(11) NOT NULL ,
  PRIMARY KEY (`id`, `wins_and_wants_id`, `wins_and_wants_user_id`, `shared_user_id`) ,
